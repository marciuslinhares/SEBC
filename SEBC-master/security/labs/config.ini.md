...
```
[root@ip-172-31-16-119 ~]# cat /etc/cloudera-scm-agent/config.ini
[General]
# Hostname of the CM server.
server_host=ip-172-31-16-119.ec2.internal
...
[root@ip-172-31-16-119 ~]# https://54.158.23.121:7183/cmf
